...
export default function indexUnidad() {
    ...
    useEffect(() => {
        onSnapshot(query(doc(db, "11111", "Niveles", "Nivel_4", router.query.id)), (querySnapshot) => {
    ...
    const handleSubmit1 = (e) => {
        e.preventDefault()
        if (data1.Definicion != '') {
            actualizar_unidad("11111", "Nivel_4", router.query.id, data1);
    ...
    const handleSubmit2 = (e) => {
        e.preventDefault()
        if (data2.Video != '') {
            actualizar_unidad("11111", "Nivel_4", router.query.id, data2);
    ...
    const agregarObjetivos = async (e) => {
        ...
        if (AgregarObjetivos != ''){
        const referencia = doc(db, "11111", "Niveles", "Nivel_4", router.query.id);
    ...
    console.log("No se aditen campos vacios")
}
    }
    ...
    return (
        <>
            <div className="section-contenido">
                <Link href="/Unidad4/Unidad"><button className="btn-back">
