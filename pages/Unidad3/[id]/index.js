...
export default function indexUnidad() {
    ...
    useEffect(() => {
        onSnapshot(query(doc(db, "11111", "Niveles", "Nivel_3", router.query.id)), (querySnapshot) => {
    ...
    const handleSubmit1 = (e) => {
        e.preventDefault()
        if (data1.Definicion != '') {
            actualizar_unidad("11111", "Nivel_3", router.query.id, data1);
    ...
    const handleSubmit2 = (e) => {
        e.preventDefault()
        if (data2.Video != '') {
            actualizar_unidad("11111", "Nivel_3", router.query.id, data2);
    ...
    const agregarObjetivos = async (e) => {
        ...
        const referencia = doc(db, "11111", "Niveles", "Nivel_3", router.query.id);
    ...
    return (
        <>
            <div className="section-contenido">
                <Link href="/Unidad3/Unidad"><button className="btn-back">
