        ...
        <div> 
            ...
            {posicionActual == "principal" ?
                <>
                    ...
                    <Completa id={router.query.id} ButtonAtras={() => setPosicion("principal")} />
                    : posicionActual == "VyF" ?
                        <VyF id={router.query.id} ButtonAtras={() => setPosicion("principal")} />
                        :posicionActual == "seleccionmultiple" ? 
                        <Seleccionmultiple id={router.query.id} ButtonAtras={() => setPosicion("principal")}/>
                        :posicionActual == "razona"?
                        <Razona id={router.query.id} ButtonAtras={() => setPosicion("principal")}/>
                        :<h1>hey</h1>
            }
        </div>
