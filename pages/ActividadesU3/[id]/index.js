            ...
            {posicionActual == "principal" ?
                <>
                    <div className="section-contenido">
                        <Link href="/ActividadesU3/Actividad"><button className="btn-back">
                            <img className="img-back" src="/back.png" />
                        </button></Link>
                        <h1 className="h1-position">{"Actividades de la Unidad 3" + "-" + router.query.id}</h1>
                    ...
                    <Completa nivel={"Nivel_3"} id={router.query.id} ButtonAtras={() => setPosicion("principal")} />
                    : posicionActual == "VyF" ?
                        <VyF nivel={"Nivel_3"} id={router.query.id} ButtonAtras={() => setPosicion("principal")} />
                        :posicionActual == "seleccionmultiple" ? 
                        <Seleccionmultiple nivel={"Nivel_3"} id={router.query.id} ButtonAtras={() => setPosicion("principal")}/>
                        :posicionActual == "razona"?
                        <Razona nivel={"Nivel_3"} id={router.query.id} ButtonAtras={() => setPosicion("principal")}/>
                        :<h1>hey</h1>
            }
        </div>
